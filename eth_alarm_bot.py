...
PROMPT_ANALYZE_AND_SELECT = (
    ...
    "2.  **Ты ОБЯЗАН выбрать ОДНОГО, относительно лучшего кандидата**, даже если ни один из них не идеален. Твой выбор должен быть основан на лучшей комбинации факторов (соответствие тренду H1, сила ADX, RSI и т.д.).\n"
    "3.  Для этого лучшего кандидата сгенерируй полный торговый сетап: логичный SL (за локальным экстремумом), TP (перед следующим уровнем) и постарайся достичь R:R не менее 1.5, если это возможно.\n\n"
    "ТРЕБОВАНИЯ К ОТВЕТУ:\n"
