...
# ============================================================================
# v8.2 - Final-Log
# • Скорректирован текст оповещений в Telegram согласно требованиям.
# ============================================================================
...
async def scanner_loop(app):
    ...
    try:
        ...
        log.info(f"Found {total_usdt_count} total SPOT USDT pairs on the exchange.")
        ...
        # ---> Сообщение 1 <---
        await broadcast_message(app, f"1. Найдено {total_usdt_count} монет к USDT.")
    except Exception as e:
...
async def cmd_start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if not task or task.done():
        ...
        await update.message.reply_text("✅ Сканер запущен (v8.1 Detailed Logging).")
